...
export const NotFound = () => {
    ...
    return (
        <div className="h-screen w-full flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800 text-center">
            ...
            <h2 className="text-2xl font-semibold text-gray-600 dark:text-gray-300 mb-6">¡Ups! Página no encontrada</h2>
            ...
            <div className="flex gap-4">
                <Button 
                    ...
                    className="p-button-outlined text-blue-primary dark:bg-white"
                />
            </div>
        </div>
    );
