                                            ...
                                            <Password 
                                                ...
                                                pt={{
                                                    showIcon: { 
                                                        ...
                                                        style: { width: '1.5em', height: '1em', top: '-0.2rem', position: 'relative' } },
                                                    hideIcon: { className: 'text-lg md:text-xl lg:text-2xl', style: { width: '1.5em', height: '1em', top: '-0.2rem', position: 'relative' } }
                                                }}
                                                placeholder="********"
                                                toggleMask
                                                feedback={false}
